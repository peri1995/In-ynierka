...
while licz_realizatorow <= 29:
    ...
    for j in range(0, 10):
        ...
        tabela = tabela.append({'Ilosc realizatorow': licz_realizatorow, 'Ilosc zadan': licz_zadan, 'Q_sys': Q_sys, 'Q_sek': Q_sek, '[(Q_sek - Q_sys)/Q_sys] * 100': delta}, ignore_index = True)
...
tabelka.to_excel('Iteracja po realizatorach.xlsx', index = False)
